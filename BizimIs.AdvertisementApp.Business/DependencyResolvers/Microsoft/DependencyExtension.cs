...
using BizimIs.AdvertisementApp.Business.Services;
using BizimIs.AdvertisementApp.Business.ValidationRules;
...
namespace BizimIs.AdvertisementApp.Business.DependencyResolvers.Microsoft
{
